<?php if(get_field('add_testimonial','options')) { ?>
    ...
    <p class="sidebar-more"><a href="/testimonials/" title="View more testimonials">View More Testimonials</a> <span class="icon-tick-down"></span></p>
...
<?php if(get_field('add_practice_area_menu','options')) { ?>
    ...
    <div class="sidebar-menu">
        ...
        <div class="spacer-30"></div>
        <p class="sidebar-more"><a href="/practice-areas/" title="View All Practice Areas">View All Practice Areas</a> <span class="icon-tick-down"></span></p>
    </div>
<?php } ?>