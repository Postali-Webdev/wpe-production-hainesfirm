<?php 
    ...
    $color_social_bg = get_field('color_footer_social_bg','options');
    $color_social_bg_hover = get_field('color_footer_social_hover','options');
...
<style type="text/css">  
    ...
    header #header-top #header-top_right #header-top_right_menu .menu li:hover a { color:<?php echo $color_secondary_1; ?>; } */
    ...
    header #header-top #header-top_right #header-top_right_menu .menu li .sub-menu { background: <?php echo $color_submenu_bg; ?>; }
    header #header-top #header-top_right #header-top_right_menu .menu li .sub-menu li:hover { background: <?php echo $color_submenu_bg; ?>; }
    ...
    @media screen and (min-width:1024px) {
        .nav-btn a {
            background: <?php echo $color_primary_menu_contact_bg; ?> !important;
            color: <?php echo $color_primary_menu_contact; ?> !important;
            border: 2px solid <?php echo $color_primary_menu_contact_bg; ?> !important;
            padding: 10px 9px !important;
            margin-right: 10px;
            text-align: center;
            
        }
        header #header-top_right_menu #menu-main-menu .nav-btn a:before {
            display:none !important;
        }
        .nav-btn a:hover {
            background: <?php echo $color_primary_menu_contact_bg_hover; ?>!important;
            color: <?php echo $color_primary_menu_contact_hover; ?>!important;
        }
    }
    ...
    /* blocks */
    .awards .wrapper { background:<?php echo $color_secondary_1; ?> !important; }
    ...
    <?php if ($primary_button_style == 'bordered') { ?>
    .btn.primary { font-family: <?php echo $GLOBALS['font_paragraph']; ?>; background:<?php echo $primary_button_background_color; ?>; border:<?php echo $primary_button_border_weight; ?>px solid <?php echo $primary_button_border_color; ?>; color:<?php echo $primary_button_text_color; ?>; border-radius:<?php echo $primary_button_border_radius; ?>px; box-sizing:border-box; }
    <?php } else { ?>
    .btn.primary { font-family: <?php echo $GLOBALS['font_paragraph']; ?>; background:<?php echo $primary_button_background_color; ?>; color:<?php echo $primary_button_text_color; ?>; box-sizing:border-box; border:none; }
    <?php } ?>

    <?php if ($primary_button_style == 'bordered') { ?>
    .btn.primary:hover { font-family: <?php echo $GLOBALS['font_paragraph']; ?>; background:<?php echo $primary_button_background_color_hover; ?>; border:<?php echo $primary_button_border_weight; ?>px solid <?php echo $primary_button_border_color; ?>; color:<?php echo $primary_button_text_color_hover; ?> !important; border-radius:<?php echo $primary_button_border_radius; ?>px; box-sizing:border-box; }
    <?php } else { ?>
    .btn.primary:hover { font-family: <?php echo $GLOBALS['font_paragraph']; ?>; background:<?php echo $primary_button_background_color_hover; ?>; color:<?php echo $primary_button_text_color_hover; ?> !important; box-sizing:border-box; border:none; }
    <?php } ?>
    ...
    .banner .main-contact .contact-block-right a:hover { color:<?php echo $color_primary_1; ?> }
    ...
    .footer .container .columns a.social-link span { background-color: <?php echo $color_social_bg; ?> !important; }
