<section class="banner">
    <div class="container">
        ...
        <?php } ?>
        <div class="columns <?php if(is_post_type_archive('reviews')) { echo "review_banner"; }?>">
            <?php if(is_post_type_archive('reviews')) { ?> <!-- for testimonials -->
                ...
                <div class="column-50 featured-review">
            ...
            <?php } elseif(is_404()) { ?> <!-- for 404 error posts -->
                <div class="column-66 featured">
                    ...
                    <div class="main-contact">
                        ...
                        <?php if (!is_page_template('page-contact.php')) { ?>
                        <div class="contact-block-right">
                            <p><a href="<?php echo home_url('/contact'); ?>" title="Online form">Online Form</a></p>
                        </div>
                        <?php } ?>
                    </div>
                </div>
            ...
            <?php } elseif(is_single()) { ?> <!-- for blog posts -->
                <div class="column-66 featured">
                    <?php $publish_date = get_the_date(); ?>
                    <p class="header-callout">WRITTEN BY JOHN HAINES <span>| PUBLISHED ON: <?php echo $publish_date; ?></span></p>
                    <h1><?php the_title(); ?></h1>
                </div>
            ...
            <div class="column-66 block featured">
                <h1>
                    <?php 
                    if(get_field('page_title_h1')) {
                        the_field('page_title_h1');
                    } else {
                        the_title();
                    }
                    ?>
                ...
                <p><?php the_field('banner_value_proposition'); ?></p>
                <div class="spacer-30"></div>
                <p class="cta">Free Family Law Consultations </p>
                <div class="spacer-15"></div>
                <div class="main-contact">
                    <div class="contact-block-left">
