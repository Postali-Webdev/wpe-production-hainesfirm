...
<script>
    jQuery("<div class='all-pages'>View All Pages <span></span></div>").insertBefore('.children');
    jQuery('.all-pages').click(function() {
        jQuery(this).toggleClass("active");
        jQuery(this).parent().find('.children').toggleClass("active");
        jQuery(this).parent().find('.children').slideToggle(400);
	});
</script>
