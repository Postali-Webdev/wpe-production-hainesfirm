 ...
 */
	...
	function postali_parent_scripts() {
        ...
        wp_register_script('fitvids-scripts', get_template_directory_uri() . '/assets/js/fitvids.min.js',array('jquery'), null, true); 
		...
		if ($args->theme_location == 'header-nav') {
			...
			<li class="menu-item menu-item-search search-holder">
				<form class="navbar-form-search" role="search" method="get" action="/">
					...
					<button title="search site" type="submit" class="btn btn-search" id="search-button"><span class="icon-search-icon" aria-hidden="true"></span></button>
				</form>	
			</li>
